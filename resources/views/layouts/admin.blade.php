    ...
    <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-md-block"><a href="{{ '../posts' }}" class="nav-link">Home</a></li>
                <li class="nav-item d-none d-md-block"><a href="{{ '../contacts' }}" class="nav-link">Contact</a></li>
            </ul>
